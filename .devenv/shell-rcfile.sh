...
source "/Users/nathanaelsantschi/Repos/Mind-Map-Maker/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/var/folders/00/6mt4rpt10cx7gs354g0g326m0000gn/T/devenv-reload-56739.sh" ]; then
        ...
        source "/var/folders/00/6mt4rpt10cx7gs354g0g326m0000gn/T/devenv-reload-56739.sh"
        rm -f "/var/folders/00/6mt4rpt10cx7gs354g0g326m0000gn/T/devenv-reload-56739.sh"
